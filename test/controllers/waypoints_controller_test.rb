...
class WaypointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create waypoint" do
    assert_difference('Waypoint.count') do
      post waypoints_url, params: { waypoint: { date: @waypoint.date, latitude: @waypoint.latitude, logbook: @waypoint.logbook, longitude: @waypoint.longitude } }
    end
  ...
  test "should update waypoint" do
    patch waypoint_url(@waypoint), params: { waypoint: { date: @waypoint.date, latitude: @waypoint.latitude, logbook: @waypoint.logbook, longitude: @waypoint.longitude } }
